...
//declarando al tensor 
    ...
    // concatenacion
    static Tensor concat(const vector<Tensor>& tensores, size_t axis);

    //las funciones amigas permitidas
...
//declarandola para que otros archivos puedan llamar a las funciones
#endif